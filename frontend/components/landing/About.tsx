...
export default function About() {
  ...
  return (
    <section
      id="about"
      className="w-full h-[80vh] flex flex-col justify-center py-8 relative overflow-hidden"
    >
      {/* Decorative elements */}
                ...
                <div className="group relative">
                  ...
                  <div className="relative flex items-center space-x-4 p-4 rounded-2xl border border-transparent group-hover:border-primary/20 transition-all duration-500">
                    ...
                    <div className="flex-shrink-0 relative">
                      ...
                      {/* Pulse effect */}
                      <div className="absolute inset-0 w-10 h-10 bg-primary/20 rounded-full animate-ping opacity-0 group-hover:opacity-30"></div>
                    </div>
