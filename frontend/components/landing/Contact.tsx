  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-20 right-20 w-40 h-40 bg-secondary/10 rounded-full blur-2xl animate-pulse"></div>
        <div className="absolute bottom-20 left-20 w-32 h-32 bg-secondary/5 rounded-full blur-2xl animate-pulse delay-1000"></div>
      </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <Input
                        ...
                        className="transition-all duration-300 focus:border-primary/50 hover:border-primary/30 bg-background text-foreground"
                      />
                      <Input
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div
                        key={item.title}
                        className="group flex items-start space-x-4 p-4 rounded-lg hover:bg-secondary/5 transition-all duration-300 hover:scale-[1.02]"
                      >
                ...
                <Card className="group p-6 bg-gradient-to-r from-secondary/10 to-secondary/5 border-secondary/20 hover:border-secondary/40 transition-all duration-500 hover:shadow-xl hover:scale-[1.02] bg-card">
                  <CardContent className="p-0">
                    ...
                    <Button
                      variant="outline"
                      className="w-full group/btn hover:bg-primary hover:text-primary-foreground border-primary text-foreground transition-all duration-300"
                    >
                      Join Community
