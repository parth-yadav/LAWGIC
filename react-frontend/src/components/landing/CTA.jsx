  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-br from-secondary/10 via-secondary/5 to-background w-full relative">
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-gradient-to-r from-secondary/20 to-secondary/10 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gradient-to-r from-secondary/10 to-primary/10 rounded-full blur-3xl animate-pulse delay-1000" />
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Reveal type="bottomUp" duration={0.8} delay={0.4}>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
              Experience <span className="text-secondary font-bold">our AI-powered prototype</span> that helps you understand legal documents. Get clear insights in <span className="text-secondary font-bold">minutes, not hours</span>.
            </p>
          </Reveal>
          ...
          <Reveal type="bottomUp" duration={0.8} delay={0.6}>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link to="/login">
                <Button size="lg" className="group text-lg px-8 py-6 rounded-full relative overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/25">
              ...
              <Button variant="outline" size="lg" className="group text-lg px-8 py-6 rounded-full border-2 hover:border-secondary/50 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:bg-secondary/5 text-primary border-secondary">
          ...
          <Reveal type="fadeIn" duration={1} delay={0.8}>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              {[
                { icon: CheckCircleIcon, title: "Free Prototype", subtitle: "No Account Required" },
                { icon: ZapIcon, title: "Instant Results", subtitle: "Upload & Test AI Analysis" },
                { icon: ShieldCheckIcon, title: "Demo Environment", subtitle: "Safe Testing Space" },
              ].map((feature) => (
