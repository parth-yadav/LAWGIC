...
export default function DashboardPage() {
  ...
  const [view, setView] = useLocalState("document-list-view", "list");
  const [sort, setSort] = useLocalState("document-sort", "createdAt");
  const [order, setOrder] = useLocalState("document-order", "desc");
        ...
        {documentList.map((doc) => (
          ...
          >
            ...
            >
              ...
              >
                <img
                  src={`${import.meta.env.VITE_SERVER_URL}/documents/${doc.id}/thumbnail`}
